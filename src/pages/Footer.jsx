  ...
  render() {
    return (
      <div className='relative h-[30vh] w-full bg-[#1660cf] text-white overflow-hidden'>
        <div className='flex flex-row gap-3 w-[55%] m-auto absolute inset-x-0 bottom-[-90px] lg:bottom-[-70px] h-[30vh]'>
            <img 
            ...
            <div className='flex flex-col gap-1 text-start' >
                ...
                <p className='pt text-[10px] lg:text-[12px]'>orem ipsum dolor sit, amet consectetur adipisicing elit. Facilis
