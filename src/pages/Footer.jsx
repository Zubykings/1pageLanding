...
export default class Footer extends Component {
  render() {
    return (
      <div className="relative lg:h-[30vh] h-[20vh] w-full bg-[#1660cf] text-white overflow-hidden flex items-center justify-center">
        <div className="flex flex-row gap-3 w-[80%] lg:w-[50%] justify-center px-5 m-auto absolute  bottom-0 ">
          <img
